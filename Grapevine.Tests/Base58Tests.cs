...
namespace Grapevine.Tests
{
    public class Base58Tests
    {
        ...
        // and then from https://github.com/adamcaudill/Base58Check/blob/master/src/Tests/EncodingTests.cs
        private readonly Tuple<string, byte[]>[] _testCases = new[]{
        ...
        private readonly Base58CheckCodec b58 = new Base58CheckCodec();
        ...
        public void TestEncode()
        {
            ...
            {
                Assert.Equal(b58.Encode(tc.Item2), tc.Item1);
            }
        }
        ...
        public void TestDecode()
        {
            foreach (var tc in _testCases)
            {
                Assert.Equal(b58.Decode(tc.Item1), tc.Item2);
            }
        }
    }
}
